...
This file will allow you to predict boxes for new pictures and will calculate their precision
'''
...
def plot_actual_vs_predicted(dataset, model, cfg, n_images=5):
	...
	for i in range(n_images):
		...
		# define subplot
		pyplot.subplot(1, 2, 0*2+1).axis('off')
		# plot raw pixel data
		pyplot.imshow(image)
		pyplot.title('Actual')
		# plot masks
		...
		pyplot.subplot(1, 2, 0*2+2).axis('off')
		# plot raw pixel data
		pyplot.imshow(image)
...
# load model weights
model_path = 'mask_rcnn_salamander_cfg_0002.h5'
